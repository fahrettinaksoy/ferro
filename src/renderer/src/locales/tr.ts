export default {
  ...
  transfer: {
    ...
    emptyQueued: 'Kuyrukta bekleyen yok',
    emptyCompleted: 'Henüz bir şey aktarılmadı',
    emptyFailed: 'Başarısız aktarım yok',
    cancel: 'İptal'
  },
  log: {
    title: 'Günlük',
  ...
  validation: {
    ...
    minLength: 'En az {n} karakter',
    port: 'Geçerli bir port girin (1–65535)'
  },
  errors: {
  ...
  cloudSync: {
    ...
    subtitle: 'Cihazlar arası — siteler + ayarlar',
    intro:
      'Sitelerinizi ve uygulama ayarlarınızı kendi cihazlarınız arasında uçtan uca şifreli olarak eşitleyin. Veri cihazınızdan çıkmadan sync parolanızla şifrelenir — uzak depo yalnızca şifreli blob’u görür.',
    ...
    autoTitle: 'Otomatik senkron',
    autoSync: 'Açılışta otomatik çek',
    autoPush: 'Site değişikliğinde otomatik gönder',
    ...
    pushed: 'Gönderildi ({sites} site, şifreli)',
    ...
    remoteEmpty: 'Uzak depoda henüz eşitleme verisi yok — önce "Gönder" kullanın',
    neverSynced: 'Henüz eşitleme yapılmadı.',
    lastSync: 'Son eşitleme: {when} ({dir})',
    push_dir: 'gönderme',
    pull_dir: 'indirme',
    checkStatus: 'Durumu kontrol et',
    statusUpToDate: 'Güncel — uzak kopya son eşitlemeyle aynı',
    statusRemoteChanged: 'Uzakta yeni değişiklik var — indirmeniz önerilir',
    badgeUpToDate: 'Güncel',
    badgeRemoteChanged: 'Uzakta değişiklik var',
    badgeUnknown: 'Durum bilinmiyor',
    ...
    overwriteTitle: 'Uzaktaki değişikliğin üzerine yaz?',
    overwriteText:
      'Uzak kopyada, son eşitlemenizden sonra yapılmış değişiklikler var. Göndermek bunların üzerine yazabilir. Önce indirmeyi düşünün.',
    overwriteConfirm: 'Yine de gönder'
  },
  team: {
    title: 'Ekipler',
    subtitle: '{count} ekip · paylaşılan şifreli kasa',
    intro:
      'Ekip = paylaşılan bir depodaki (Gist/WebDAV) uçtan uca şifreli site kasası. Davetle üye ekleyin; herkes aynı siteleri paylaşır. Roller işbirlikçidir (uygulama düzeyinde uygulanır).',
    noTeams: 'Henüz bir ekip yok. Oluşturun veya bir davetle katılın.',
    summary: '{members} üye · {sites} site',
    roles: {
      admin: 'Yönetici',
      member: 'Üye',
    ...
    create: 'Ekip Oluştur',
    createTitle: 'Yeni Ekip',
    createHint:
      'Ekip verisi cihazınızda üretilen rastgele bir ekip anahtarıyla şifrelenir. Depo (Gist/WebDAV) yalnızca şifreli kasayı görür.',
    join: 'Davetle Katıl',
    joinTitle: 'Ekibe Katıl',
    joinHint: 'Yöneticiden aldığınız davet kodunu ve ayrı iletilen PIN’i girin.',
    name: 'Ekip adı',
    yourName: 'Görünen adınız',
    yourNameHint: 'Üye listesinde bu adla görünürsünüz (örn. e-posta/isim).',
    gistToken: 'GitHub Token (gist yetkili)',
    gistId: 'Gist ID (boşsa yeni oluşturulur)',
    gistIdHint: 'Boş bırakırsanız ilk paylaşımda gizli bir gist oluşturulur.',
    webdavUrl: 'WebDAV klasör adresi',
    inviteCode: 'Davet kodu',
    invitePin: 'Davet PIN’i',
    invitePinHint: 'En az 4 karakter. Kodu ve PIN’i AYRI kanaldan iletin.',
    invitePinReminder: 'PIN’i ayrı bir kanaldan (kodla aynı mesajda değil) iletin.',
    created: 'Ekip oluşturuldu',
    joined: 'Ekibe katıldınız',
    left: 'Ekipten ayrıldınız',
    pull: 'Çek',
    share: 'Site Paylaş',
    importSites: 'Site Yöneticime Aktar',
    leave: 'Ayrıl',
    leaveTitle: 'Ekipten ayrıl',
    leaveConfirm:
      'Bu ekip cihazınızdan kaldırılacak (uzak kasa ve diğer üyeler etkilenmez). Emin misiniz?',
    members: 'Üyeler',
    noMembers: 'Üye bilgisi için önce “Çek”e basın.',
    removeMember: 'Üyeyi çıkar',
    memberRemoved: 'Üye çıkarıldı',
    roleChanged: 'Rol güncellendi',
    inviteTitle: 'Üye davet et',
    inviteHint: 'Bir rol seçin, bir PIN belirleyin ve davet kodunu üretin.',
    inviteRole: 'Rol',
    generateInvite: 'Davet Üret',
    copyCode: 'Kodu Kopyala',
    copied: 'Kod panoya kopyalandı',
    copyFailed: 'Kopyalanamadı',
    pulled: 'Kasa çekildi ({sites} site)',
    shared: '{added} yeni site paylaşıldı',
    shareTitle: 'Paylaşılacak siteleri seçin',
    shareHint: 'Seçtiğiniz siteler (parolalarıyla) şifreli kasaya eklenir.',
    shareCount: '{count} site seçildi',
    imported: '{imported} site aktarıldı, {skipped} yinelenen atlandı',
    remoteEmpty: 'Uzak kasa henüz boş',
    neverSynced: 'Henüz eşitlenmedi',
    lastSync: 'Son eşitleme: {when}',
    readonlyNote: 'Salt-okunur üyesiniz — siteleri kullanabilir ama kasaya yazamazsınız.'
  }
}
